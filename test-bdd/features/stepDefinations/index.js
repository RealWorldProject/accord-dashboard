...
Given("Test Add Category functionality", { timeout: 30000 }, async function () {
  ...
  await driver.findElement(By.id("category")).sendKeys("action");
  ...
  await driver.wait(until.elementLocated(By.xpath('//*[@id="MUIDataTableBodyRow-0"]/td[5]/div[2]/div/button[1]')), 300);
  expect(await driver.wait(until.elementLocated(By.xpath('//*[@id="MUIDataTableBodyRow-0"]/td[2]/div[2]'))));
  // await driver.quit();
});
